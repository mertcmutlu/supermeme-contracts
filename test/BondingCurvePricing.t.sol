...
//         testToken = factory.createToken{value: createTokenRevenue}(
//             "SuperMeme",
//             "MEME",
//             false,
//             0,
...
//             //console.log("Price per token: ", pricePerToken, " Total supply: ", totalSupply);
//         }
//     }
...
//             //console.log("Price per token: ", pricePerToken, " Total supply: ", totalSupply);
//             if (i == 159) {
//                 //console.log(pricePerToken*totalSupply / (10 ** 18));
//                 //console.log(address(testTokenInstanceRefund).balance);
//                 //console.log(testTokenInstanceRefund.totalEtherCollected());
//             }
//         }
//     }
...
//             //console.log("Price per token: ", pricePerToken, " Total supply: ", totalSupply);
//         }
//         //console.log("totalEtherCollected:", testTokenInstanceDegen.totalEtherCollected());
